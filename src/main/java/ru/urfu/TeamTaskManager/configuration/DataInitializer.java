...
public class DataInitializer {
    ...
    CommandLineRunner init(UserRepository userRepository,
        ...
        return args -> {
            ...
            User leaderUser = userService.createUser(CreateUserRequest.builder()
                    .username("leader")
                    .email("leader@mail.com")
                    .password("123")
                    .build());

            User memberUser = userService.createUser(CreateUserRequest.builder()
                    .username("member")
                    .email("member@mail.com")
                    .password("123")
                    .build());

            Team team = teamService.createTeam(leaderUser.getId(), CreateTeamRequest.builder()
                    .name("Backend Team")
